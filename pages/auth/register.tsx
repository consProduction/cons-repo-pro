...
const SignupSchema = Yup.object().shape({
  nombres: Yup.string()
    .matches(
      /(?<primernombre>[a-zA-ZáéíóúÁÉÍÓÚ])+ (?<segundonombre>[a-zA-ZáéíóúÁÉÍÓÚ])+$/g,
      "Escriba ambos nombres"
    )
    .min(3, "Muy corto")
    .max(24, "Muy largo")
  ...
  apellidos: Yup.string()
    .matches(
      /(?<primerapellido>[a-zA-ZáéíóúÁÉÍÓÚ])+ (?<segundoapellido>[a-zA-ZáéíóúÁÉÍÓÚ])+$/g,
    ...
    <>
      ...
      <Box sx={styles.mainContainer}>
        <Box sx={styles.loginContainer}>
          ...
          >
            Obtén diferentes herramientas adicionales en nuestro sitio web!
          </Typography>
          <Formik
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <TextField
                      ...
                      sx={styles.input}
                      error={
                        /[^ a-zA-ZáéíóúÁÉÍÓÚ]/g.test(values.nombres)
                          ? true
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      ...
                      sx={styles.input}
                      error={
                        /[^ a-zA-ZáéíóúÁÉÍÓÚ]/g.test(values.apellidos)
                          ? true

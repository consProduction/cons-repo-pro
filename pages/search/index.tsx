...
const SearchPage: NextPage<Props> = ({
  ...
  const InmuebleList = dynamic(() =>
    import("../../components/search").then((mod) => mod.InmuebleList)
  );
  const props = {
    inmueblesSSR,
    querySSR,
  ...
  try {
    ...
    return {
      props: {
        ...
        habitacionesSSR: ctx.query["habitaciones"]
          ? ctx.query["habitaciones"]
          : "",
        estacionamientosSSR: ctx.query["estacionamientos"]
          ? ctx.query["estacionamientos"]
          : "",
        validatedUser: {

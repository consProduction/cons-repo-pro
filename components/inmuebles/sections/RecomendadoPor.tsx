    ...
    <>
      <Box sx={styles.mobileContainer}>
        <Box sx={styles.mobileSubContainer}>
          ...
          >
            <Avatar
              src={`${process.ENV.BASE_URL}/assets/img/${userData.foto}`}
          ...
          <Box sx={styles.mobileDataContainer}>
            ...
            <Typography
              ...
              color="common.white"
              fontSize={20}
              sx={{ fontFamily: "Plus Jakarta Sans", textAlign: "start" }}
            >{`${userData.nombre_y_apellido}`}</Typography>
      ...
      <Box sx={styles.pcSubContainer}>
        <Box sx={styles.pcAvatar}>
          <Avatar
            src={`${process.ENV.BASE_URL}/assets/img/${userData.foto}`}
            sx={{
              width: { xs: 100, md: 100, lg: 150 },
              height: { xs: 100, md: 100, lg: 150 },
            }}
          />
        </Box>
        <Box sx={styles.pcDataContainer}>
          ...
          <Typography
            variant="h5"
            color="common.white"
            sx={{ ...styles.pcDataText, fontSize: 24, mb: 1 }}
          >{`${userData.nombre_y_apellido}`}</Typography>
          <Box sx={{ display: "flex", alingItems: "center" }}>
            <LocalPhoneIcon sx={{ color: "#FFF", width: 18, height: 18 }} />
            <Typography
      ...
      <Box sx={styles.pcTextContainer}>
        ...
        >
          ...
          <Button
            ...
            href={`https://www.facebook.com/share.php?u=https://consolitex.org/inmueble/${
              data.ficha_id
            }${userData.ref ? "?ref=" + userData.ref : ""}&quote=${utf8_encode(
              ucfirst(data.descripcion_web.toLowerCase())
            )}...%0AConsolitex%20%7C%20Bienes%20Raices%0Ahttps://consolitex.org/inmueble/${
              data.ficha_id
            }${userData.ref !== "" ? "?ref=" + userData.ref : ""}`}
...
const styles = {
  mobileContainer: {
    ...
    borderRadius: 5,
    background:
      "linear-gradient(327deg, rgba(4,156,255,1) 0%, rgba(0,35,116,1) 100%)",
    width: "100%",
    p: 2,
    mb: 1,
    mt: {
  ...
  pcButton: {
    minWidth: { sm: 40, md: 40, lg: 50 },
    maxWidth: { sm: 40, md: 40, lg: 50 },
    height: { sm: 40, md: 40, lg: 50 },
    borderRadius: "50%",
    background: "#FFF",
    marginInline: 1,
